      ...
      @foreach ($ebooks as $eb)
        <div class="card p-0 overflow-hidden group hover:shadow-xl transition-all" style="border:1px solid var(--c-border-light)">
            <div style="position:relative; width:100%; height:220px; background:var(--c-bg-card); display:flex; align-items:center; justify-content:center; overflow:hidden">
              <div style="width:100%; height:100%; background: linear-gradient(135deg, #4f46e5, #7c3aed); display:flex; flex-direction:column; align-items:center; justify-content:center; color:#fff; transition:transform 0.5s;" class="group-hover:scale-110">
                <svg width="56" height="56" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" style="margin-bottom:12px; opacity:0.9;"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"></path><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"></path></svg>
                <div style="font-size:16px; font-weight:800; letter-spacing:1px; opacity:0.9;">E-BOOK</div>
              </div>
