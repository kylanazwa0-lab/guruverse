...
foreach ($members as $m) {
    ...
    $sheet->setCellValue('C' . $rowNum, $m['username']);
    $sheet->setCellValue('D' . $rowNum, $m['institution']);
    $sheet->setCellValue('E' . $rowNum, $m['password']);
    $sheet->setCellValue('F' . $rowNum, $m['phone']);
    $sheet->setCellValue('G' . $rowNum, date('d/m/Y H:i', strtotime($m['joined_at'])));
