<?php
// admin/views/gamifikasi_manage.php
...
function previewGmFile(file) {
  fetch('/guruverse/asset/docs/gamifikasi/' + encodeURIComponent(file))
    .then(r => r.text())
    .then(t => {
