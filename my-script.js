...
const Nav=({view,go})=>(
  <nav className="nav">
    <a className="nav-logo" href="index.php">
      <img src="asset/img/FA Logo Guruverse.ID - nrgative.png" alt="Guruverse.id" onError={e=>e.target.style.display='none'}/>
    </a>
    <ul className="nav-links">
      <li><a href="index.php">Beranda</a></li>
      <li><a href="#" className={view==='register'?'on':''} onClick={e=>{e.preventDefault();go('register');}}>Akses Anggota</a></li>
      <li><a href="guru-belajar/Dashboard/about.php">Tentang Kami</a></li>
    </ul>
  </nav>
);
  ...
  return(
    <div className="cosmos-wrap">
      <div className="cosmos">
        ...
        <div className="core">
          <img src="asset/img/FA Logo Guruverse.ID - nrgative.png" style={{width:32,objectFit:'contain',filter:'brightness(2.5)'}} onError={e=>e.target.style.display='none'} alt="G"/>
        </div>
        {orbs.map((o,i)=>(
          ...
          <div style={{display:'flex',flexDirection:'column',gap:6,paddingLeft:2}}>
            <div>
              <div style={{display:'flex',alignItems:'center',gap:4,marginBottom:3}}>
                ...
                <span style={{fontSize:'5px',fontWeight:800,textTransform:'uppercase',letterSpacing:'.18em',color:'#fbbf24'}}>Visi</span>
              </div>
            ...
            <div>
              <div style={{display:'flex',alignItems:'center',gap:4,marginBottom:3}}>
                ...
                <span style={{fontSize:'5px',fontWeight:800,textTransform:'uppercase',letterSpacing:'.18em',color:'#a78bfa'}}>Misi</span>
              </div>
...
const MemberMenu = ({ member, onCard, onOut }) => {
  const pillars = [
    { t: 'Guru Belajar', s: '"Guru yang terus tumbuh dan memperdalam ilmunya."', c: '#3b82f6', ic: 'BookOpen', href: 'guru-belajar/index.php', img: 'asset/img/pilar_learning.png', bg: '#eff6ff' },
    { t: 'Guru Mengajar', s: '"Guru yang mengimplementasikan nilai dan berdampak bagi murid serta komunitas."', c: '#10b981', ic: 'Users', href: '#', img: 'asset/img/pilar_teaching.png', bg: '#ecfdf5' },
    { t: 'Guru Inspira', s: '"Guru yang saling menguatkan dan berbagi semangat."', c: '#8b5cf6', ic: 'Zap', href: '#', img: 'asset/img/pilar_innovation.png', bg: '#f5f3ff' },
  ];
      ...
      <main className="dash-main">
        ...
        <section className="dash-hero">
          ...
          <div className="dash-hero-img">
            <img src="asset/img/dashboard_hero.png" alt="Hero" />
...
const App=()=>{
  ...
  const onAdminLogin=()=>{
    window.location.href = 'guru-belajar/Dashboard/index.php'; // Atau admin dashboard yang benar
  };
  ...
  const pillars=[
    {t:'Guru Belajar',s:'Pengembangan Diri & Kompetensi',c:'#a78bfa'},
    {t:'Guru Mengajar',s:'Aksi Nyata & Kontribusi',c:'#38bdf8'},
    {t:'Guru Inspira',s:'Jejaring, Kolaborasi, & Inspirasi',c:'#34d399'},
  ];
