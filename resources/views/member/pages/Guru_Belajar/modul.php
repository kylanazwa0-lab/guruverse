...
<div id="coursePlayerContent" style="display:none; width:100%; min-width:0; box-sizing:border-box;">
  ...
  <div class="gvcp-banner" id="gvcpBanner">
    <div class="gvcp-banner-body">
      <button class="gvcp-back" onclick="showPage('kelas')">
  ...
  <div class="gvcp-grid">
    ...
    <aside class="gvcp-aside">
      ...
      <div class="gvcp-card gvcp-help-card">
        ...
        <button class="btn btn-outline btn-sm" style="width:100%;" onclick="showPage('diskusi')">Forum Diskusi</button>
      </div>
    ...
    <div class="gvcp-main" style="min-width:0;">
      ...
      <div id="cpCourseCompleteBanner" class="gvcp-complete" style="display:none;">
        ...
        <button class="btn" style="background:#fff;color:#059669;font-weight:800;font-size:13px;padding:10px 28px;border-radius:10px;border:none;cursor:pointer;" onclick="showPage('sertifikat')">Lihat Sertifikat &rarr;</button>
      </div>
      ...
      <div class="gvcp-resources">
        ...
        <div class="gvcp-card gvcp-res-card">
          ...
          <a href="#" class="gvcp-link" onclick="showPage('diskusi'); return false;">
...
function _cpShowError(el, msg) {
  ...
  el.innerHTML = `
    <div class="gvcp-empty">
      ...
      <div class="gvcp-empty-btns">
        <button class="btn btn-primary" onclick="showPage('kelas')">Kembali ke Kelas</button>
