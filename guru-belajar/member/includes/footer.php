...
const NotifSystem = {
  ...
  showBrowserNotif(notif) {
    ...
    const n = new Notification(emoji + ' ' + notif.title, {
      body: notif.body,
      icon: '/guruverse/asset/img/FA Logo Guruverse.ID - main.png',
      badge: '/guruverse/asset/img/FA Logo Guruverse.ID - main.png',
...
function viewCertificate(path) {
    ...
    const url = '/guruverse/uploads/certificates/' + path;
    let content = '';
    if (isPdf) {
