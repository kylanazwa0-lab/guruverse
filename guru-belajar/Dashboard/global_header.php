<nav class="navbar">
  <div class="navbar-inner">
    <a href="index.php" class="nav-logo" style="text-decoration:none !important; border:none !important;">
      <img src="../../asset/img/FA Logo Guruverse.ID - nrgative.png" 
           alt="Guruverse.ID" 
           id="nav-logo-img"
           class="logo-img-nav" 
           style="height:36px; border:none; object-fit:contain; display:block;">
    </a>
    <div class="nav-links">
      <button class="nav-link" id="nav-index" onclick="window.location.href='index.php'">Beranda</button>
      <button class="nav-link" id="nav-about" onclick="window.location.href='about.php'">Tentang Kami</button>
...
<div class="nav-mobile" id="navMobile">
  <button class="nav-link" onclick="window.location.href='index.php'">Beranda</button>
...
<script>
  (function() {
    ...
    if (page === "index.php" || page === "") document.getElementById("nav-index").classList.add("active");
    if (page === "about.php")      document.getElementById("nav-about").classList.add("active");
