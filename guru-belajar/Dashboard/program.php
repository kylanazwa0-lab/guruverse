...
/* Light mode: hero */
[data-theme="light"] .hero-title  { color: #092B40; }
[data-theme="light"] .hero-desc   { color: #3D6175; }
...
/* Light mode: pillar column cards */
[data-theme="light"] .pillar-column-card {
  background: #ffffff;
  border-color: #D2E3EB;
  box-shadow: 0 4px 20px rgba(9, 60, 93, 0.08);
}
[data-theme="light"] .p-col-title { color: #092B40; }
[data-theme="light"] .p-col-desc  { color: #3D6175; }
[data-theme="light"] .p-feat-text { color: #3D6175; }
[data-theme="light"] .p-feat-text strong { color: #092B40; }
