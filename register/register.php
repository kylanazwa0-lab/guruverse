<?php
session_start();
// Jika sudah login, langsung redirect ke dashboard member
if (isset($_SESSION['member_int_id']) || isset($_SESSION['member_id'])) {
    header("Location: /guruverse/guru-belajar/member/home_member.php");
    exit;
}
?>
<!DOCTYPE html>
...
<!-- 1. React (Local for Instant Loading) -->
...
<!-- 3. Babel Standalone — WAJIB sebelum script type="text/babel" (Local) -->
...
<?php 
  ...
  include 'sections/login_form.js';
  include 'sections/register_form.js';
  include 'sections/member_card.js';
  include 'sections/admin_dashboard.js';
  include 'sections/member_dashboard.js';
  include 'sections/app_main.js';
?>
</script>
